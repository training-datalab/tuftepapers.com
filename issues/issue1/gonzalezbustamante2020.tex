...
\date{{\normalfont \normalsize University of Oxford} \\ {\LARGE \Letter} \href{mailto:bastian.gonzalezbustamante@politics.ox.ac.uk}{\textcolor{blue}{\normalfont \normalsize bastian.gonzalezbustamante@politics.ox.ac.uk}} \\~\\
...
\item {\small Blondel, V. D., Guillaume, J.-L., Lambiotte, R., \& Lefebvre, E. (2008). Fast unfolding of communities in large networks. {\itshape Journal of Statistical Mechanics: Theory and Experiment}, (P10008), 1-12.}
...
\item {\small Bunker, K., \& Navia, P. (2015). Incumbency Advantage and Tenure Length in the Chilean Chamber of Deputies, 1989-2009. {\itshape Revista de Ciencia Pol\'itica, 35}(2), 251-271.}
...
\item {\small Fruchterman, T. M. J., \& Reingold, E. M. (1991). Graph drawing by force-directed placement. {\itshape Software: Practice and Experience, 21}(11), 1129-1164.}
...
\item {\small Gonz\'alez-Bustamante, B., \& Cisternas, C. (2016). \'Elites pol\'iticas en el poder legislativo chileno: La C\'amara de Diputados (1990-2014). {\itshape Pol\'itica, Revista de Ciencia Pol\'itica, 54}(1), 19-52.}
\item {\small Gonz\'alez-Bustamante, B., \& Olivares, A. (2015). Rotaci\'on de subsecretarios en Chile: Una exploraci\'on de la segunda l\'inea gubernamental, 1990-2014. {\itshape Revista de Gesti\'on P\'ublica, IV}(2), 151-190.}
\item {\small Gonz\'alez-Bustamante, B., \& Olivares, A. (2018). La \'elite pol\'itica gubernamental en Chile: supervivencia de ministros (1990-2014). En A. Codato \& F.
...
\item {\small Gonz\'alez-Bustamante, B., \& Soto, D. (2016). Pluralismo en los medios digitales escritos en Chile, una exploraci\'on de casos clave. {\itshape Serie Pol\'itica, Gesti\'on y Pol\'iticas P\'ublicas}, (2), 1-26.}
\item {Hanneman, R. A., \& Riddle, M. (2005). {\itshape Introduction to Social Networks Methods}. Riverside: University of California Riverside.}
\item {\small Jacomy, M., Venturini, T., Heymann, S., \& Bastian, M. (2014). ForceAtlas2, a Continuous Graph Layout Algorithm for Handy Network Visualization Designed for the Gephi Software. {\itshape PLoS ONE, 9}(6), 1-12.}
...
\item {\small Maillet, A., Gonz\'alez-Bustamante, B., \& Olivares, A. (2016). ?`Puerta giratoria? An\'alisis de la circulaci\'on p\'ublico-privada en Chile (2000-2014). {\itshape Serie de Documentos de Trabajo PNUD-Desigualdad}, (7),  1-40.}
\item {\small Newman, M. E. J., \& Girvan, M. (2004). Finding and evaluating community structure in networks. {\itshape Physical Review E, 69}(2), 026113-1-026113-15.}
...
\item {\small Valenzuela, S., \& Arriagada, A. (2009). Competencia por la uniformidad en noticieros y diarios chilenos 2000-2005. {\itshape Cuadernos.info}, (24), 41-52.}
\item {\small Wasserman, S., \& Faust, K. (1994). {\itshape Social Network Analysis: Methods and Applications}. Nueva York: Cambridge University Press.}
\end{list}
